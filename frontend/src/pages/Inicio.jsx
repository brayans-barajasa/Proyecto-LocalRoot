...
const lugaresData = [
  {
    title: "Medellin",
    description: "Medellín, la 'Ciudad de la Eterna Primavera,' te sorprenderá con su clima agradable, paisajes montañosos y una transformación urbana sorprendente. Esta metrópolis combina historia, cultura y una vibrante escena artística en un entorno natural excepcional. ¡Descubre su encanto único!",
    image: Medellin,
  },
  {
    title: "La Piedra del Peñol",
    description: "La Piedra del Peñol, en Guatapé, Colombia, es un majestuoso monolito de granito que se alza 220 metros sobre el nivel del agua, ofreciendo vistas panorámicas espectaculares tras ascender sus 649 escalones. Es uno de los destinos turísticos más icónicos del país.",
    image: PiedraPeñol,
  },
  {
    title: "Guatapé",
    description: "Guatapé es un pintoresco pueblo en Colombia conocido por sus casas coloridas y la impresionante Piedra del Peñol, una formación de granito que ofrece vistas panorámicas espectaculares.",
    image: Pueblito,
  },
];
...
const categoryData = [
  {
    ...
    description: "Descubre un mundo de cultura y arte en cada rincón. Museos fascinantes, teatros emocionantes y eventos culturales únicos te esperan. Sumérgete en la creatividad y la expresión artística que definen nuestra comunidad. ¿Estás listo para una experiencia inigualable?",
  },
  {
    title: "Gastronomía",
    ...
    <div className='inicio-container'>
      ...
      <section className="categories-section">
        <div className="categories">
          ...
          <p>Descubre una ciudad llena de vida y cultura, desde arte y gastronomía hasta naturaleza y vida nocturna...</p>
        </div>
